...
Возможность иметь нулевое значение FK нужна, когда вы можете не знать его значения в момент 
ввода данных, но вы знаете другие значения в таблице, которые необходимо ввести.
*/
