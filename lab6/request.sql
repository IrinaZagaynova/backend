...
В SQLite данные о датах и времени хранятся в формате строк или чисел.
Есть функции принимающие строку в качестве аргумента:
datetime() возвращает дату в формате DATETIME,
julianday() возвращает юлианский день - количество дней, прошедших с полудня в Гринвиче 24 ноября 4714 г. до н.э.
